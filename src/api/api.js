...
export const addCompany = params => { return axios.get(`${base}/company/add`, { params: params }); };

export const editCompany = params => { return axios.get(`${base}/company/edit`, { params: params }); };